...
def get_parser():
    ...
    parser.add_argument(
        "--target", "-t", required=True, help="The target text file to align."
    )
    parser.add_argument(
        "--reference",
        "-r",
    ...
    parser.add_argument("--cache_dir", help="The directory to save vocabulary cache.")
    parser.add_argument(
        "--progress",
        "-p",
        action="store_true",
